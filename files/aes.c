...
/* test AES function for a given key size*/
int main() 
{
	uchar key[16];
	uint e_key[128];
...
#if 0	
	klee_make_symbolic(key, 16 * sizeof(key[0]), "key");

	klee_assume(key[0] >= 0x00);
	klee_assume(key[0] <= 0XFF);
	klee_assume(key[1] >= 0x00);
	klee_assume(key[1] <= 0xFF);
	klee_assume(key[2] >= 0x00);
	klee_assume(key[2] <= 0xFF);
	klee_assume(key[3] >= 0x00);
	klee_assume(key[3] <= 0xFF);
	klee_assume(key[4] >= 0x00);
	klee_assume(key[4] <= 0xFF);
	klee_assume(key[5] >= 0X00);
	klee_assume(key[5] <= 0XFF);
	klee_assume(key[6] >= 0X00);
	klee_assume(key[6] <= 0XFF);
	klee_assume(key[7] >= 0X00);
	klee_assume(key[7] <= 0XFF);
	klee_assume(key[8] >= 0X00);
	klee_assume(key[8] <= 0XFF);
	klee_assume(key[9] >= 0X00);
	klee_assume(key[9] <= 0XFF);
	klee_assume(key[10] >= 0x00);
	klee_assume(key[10] <= 0XFF);
	klee_assume(key[11] >= 0x00);
	klee_assume(key[11] <= 0XFF);
	klee_assume(key[12] >= 0x00);
	klee_assume(key[12] <= 0XFF);
	klee_assume(key[13] >= 0x00);
	klee_assume(key[13] <= 0XFF);
	klee_assume(key[14] >= 0x00);
	klee_assume(key[14] <= 0XFF);
	klee_assume(key[15] >= 0x00);
	klee_assume(key[15] <= 0XFF);
#endif
	KeyExpansion(key, e_key, 128);
